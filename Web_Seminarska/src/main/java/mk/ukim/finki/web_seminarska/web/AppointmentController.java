...
public class AppointmentController {
    ...
    public String showAdd(Model model, @PathVariable Long salonId, Authentication authentication) {
        ...
        model.addAttribute("userId", salonUserService.findByUsername(authentication.getName()).getId());
